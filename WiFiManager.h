...
const char HTTP_APIFORM[] PROGMEM         = "<form method='get' action='apisave'><input id='s' name='s' length=255 placeholder='URI' value=''><br/><button type='submit'>save</button></form>";
const char HTTP_APISAVED[] PROGMEM        = "<div>API Saved<br />Redirecting back to root page.<br /></div><META HTTP-EQUIV=\"refresh\" CONTENT=\"5; URL='/'\">";
...
class WiFiManager
{
  public:
    ...
    void          setAPISaveCallback(void (*func)(WiFiManager*));
  private:
    ...
    void (*_apicallback)(WiFiManager*) = NULL;
